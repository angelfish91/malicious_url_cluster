...
cfg.SECOND_DOMAIN_LEVEL_COUNT_THRESH = 3
...
# publish
cfg.PUBLISH_DOMAIN_SCORE_THRESH = 0.5
cfg.PUBLISH_DOMAIN_RATIO = 0.2
cfg.PUBLISH_DOMAIN_FP_THRESH = 10
cfg.PUBLISH_DOMAIN_TP_THRESH = 1
